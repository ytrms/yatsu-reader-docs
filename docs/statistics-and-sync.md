...
If you want Drive to be the shared place where your reading data moves between devices, set sync behavior to **All** on devices where you both read and review statistics.
